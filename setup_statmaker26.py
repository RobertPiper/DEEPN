"""
py2app setup script for StatMaker_26v1 (Python 3 / PyQt5 / native Apple Silicon,
DESeq2-based statistics).
...
Usage:
    python3 setup_statmaker26.py py2app
"""
import os
import glob
from setuptools import setup

APP_NAME = 'StatMaker_26v1'

APP = [{
    'script': 'stat_maker_gui_v2.py',
    'plist': {
        'CFBundleName': APP_NAME,
        'CFBundleDisplayName': 'Stat Maker',
        'CFBundleGetInfoString': 'DEEPN Stat Maker',
        'CFBundleIdentifier': 'edu.uiowa.robertpiper.statmaker26',
...
DATA_FILES = []
DATA_FILES += find_data_files(['ui'], ['ui'], ['Stat_Maker_v2.ui'])
