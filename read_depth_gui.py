...
class Read_Depth_Gui(QtWidgets.QMainWindow, form_class):
    ...
    def populate_accession_suggestions(self):
        self.accession_numbers_list = list(dict.fromkeys(self.accession_numbers_list))
        self.completer = QtWidgets.QCompleter(self.accession_numbers_list, self)
